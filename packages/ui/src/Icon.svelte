<script lang="ts">
  /**
   * Icon component - renders inline SVG icons
   * Uses Lucide icons, embedded for zero dependencies
   */
  
  type IconName = 
    // Navigation
    | 'home' | 'bell' | 'bot' | 'settings' | 'sun' | 'moon' | 'menu' | 'x'
    // Energy
    | 'zap' | 'plug' | 'battery-charging' | 'leaf'
    // Trends
    | 'trending-up' | 'trending-down' | 'activity'
    // Status
    | 'check' | 'alert-circle' | 'info' | 'alert-triangle'
    // Circles
    | 'circle' | 'check-circle' | 'x-circle'
    // UI
    | 'chevron-right' | 'chevron-down' | 'chevron-up' | 'chevron-left'
    | 'filter' | 'search' | 'clock' | 'calendar' | 'refresh-cw'
    | 'eye' | 'eye-off' | 'upload' | 'download' | 'trash-2' | 'edit'
    | 'external-link' | 'copy' | 'send' | 'paperclip' | 'image'
    // Chat
    | 'message-circle' | 'message-square' | 'history' | 'file' | 'folder';
  ...
  const icons: Record<string, string> = {
    ...
    'bot': 'M12 8V4H8 M12 8V4h4 M12 8a4 4 0 0 0-4 4v4a4 4 0 0 0 8 0v-4a4 4 0 0 0-4-4z M6 12h.01 M18 12h.01 M9 16h6',
    ...
    'plug': 'M12 22v-5 M9 8V2 M15 8V2 M18 8H6a2 2 0 0 0-2 2v2c0 4 3.5 7 8 7s8-3 8-7v-2a2 2 0 0 0-2-2z',
    'battery-charging': 'M15 7h1a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2h-1 M6 7H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2 M22 11v2 M7 10l3 2-3 2v-4z M13 7v10',
    ...
    'history': 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z M12 6v6l4 2 M3 12h1 M12 3v1',
...
<svg
  ...
  aria-hidden="true"
>
  <path d={icons[name] || icons['circle']} />
</svg>
