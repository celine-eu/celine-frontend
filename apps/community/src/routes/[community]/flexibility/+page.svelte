...
<style>
  ...
  .partial-banner{display:flex;gap:.6rem;align-items:center;margin-bottom:.8rem;padding:.7rem .85rem;border:1px solid var(--community-warning);border-radius:11px;background:var(--community-warning-soft);color:var(--community-warning);font-size:.68rem}.partial-banner.compact{margin:1rem 0}.metric-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:.75rem;margin-bottom:.8rem}.metric-grid article{padding:1rem;border:1px solid var(--community-border);border-radius:14px;background:var(--community-surface);box-shadow:var(--community-shadow)}.metric-grid small,.metric-grid strong,.metric-grid span{display:block}.metric-grid small{color:var(--community-muted);font-size:.63rem}.metric-grid strong{margin:.4rem 0 .15rem;font-size:1.45rem}.metric-grid em{color:var(--community-muted);font-size:.7rem;font-style:normal}.metric-grid span{color:var(--community-muted);font-size:.62rem}.metric-grid .effort strong{color:var(--community-primary-strong)}
